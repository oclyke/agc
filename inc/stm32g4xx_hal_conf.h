/**
  ...
  * @brief   HAL configuration for the AGC firmware.
  *          Derived from the driver template with every module the firmware
  *          does not use switched off. USE_FULL_ASSERT comes from the build
  *          script so that it is visible ahead of this file's includes too.
  ******************************************************************************
  * @attention
  *
...
/**
  ...
  *        HAL drivers code
  */
/* #define USE_FULL_ASSERT               1U */ /* defined on the command line by firmware/build.sh */
